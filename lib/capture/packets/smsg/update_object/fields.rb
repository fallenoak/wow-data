    ...
    module Fields
      ...
      module PlayerFields
        ...
        DEFINITIONS = {
          ...
          BASELINE + 0x7FD => :player_mastery,
          BASELINE + 0x7FE => :player_amplify,
          BASELINE + 0x7FF => :player_multistrike,
          BASELINE + 0x800 => :player_multistrike_effect,
          BASELINE + 0x801 => :player_readiness,
          BASELINE + 0x802 => :player_speed,
          BASELINE + 0x803 => :player_lifesteal,
          BASELINE + 0x804 => :player_avoidance,
          BASELINE + 0x805 => :player_sturdiness,
          BASELINE + 0x806 => :player_cleave,
          BASELINE + 0x807 => :player_versatility,
          BASELINE + 0x808 => :player_versatility_bonus,
          BASELINE + 0x809 => :player_pvp_power_damage,
          BASELINE + 0x80A => :player_pvp_power_healing,
          BASELINE + 0x80B => :player_explored_zones,
          BASELINE + 0x90B => :player_rest_state_experience,
          BASELINE + 0x90C => :player_mod_damage_done_pos,
          BASELINE + 0x913 => :player_mod_damage_done_neg,
          BASELINE + 0x91A => :player_mod_damage_done_pct,
          BASELINE + 0x921 => :player_mod_healing_done_pos,
          BASELINE + 0x922 => :player_mod_healing_pct,
          BASELINE + 0x923 => :player_mod_healing_done_pct,
          BASELINE + 0x924 => :player_mod_periodic_healing_done_pct,
          BASELINE + 0x925 => :player_weapon_dmg_multipliers,
          BASELINE + 0x928 => :player_weapon_atk_speed_multipliers,
          BASELINE + 0x92B => :player_mod_spell_power_pct,
          BASELINE + 0x92C => :player_mod_resilience_percent,
          BASELINE + 0x92D => :player_override_spell_power_by_ap_pct,
          BASELINE + 0x92E => :player_override_ap_by_spell_power_pct,
          BASELINE + 0x92F => :player_mod_target_resistance,
          BASELINE + 0x930 => :player_mod_target_physical_resistance,
          BASELINE + 0x931 => :player_local_flags,
          BASELINE + 0x932 => :player_bytes,
          BASELINE + 0x933 => :player_self_res_spell,
          BASELINE + 0x934 => :player_pvp_medals,
          BASELINE + 0x935 => :player_buyback_price,
          BASELINE + 0x941 => :player_buyback_timestamp,
          BASELINE + 0x94D => :player_kills,
          BASELINE + 0x94E => :player_lifetime_honorable_kills,
          BASELINE + 0x94F => :player_watched_faction_index,
          BASELINE + 0x950 => :player_combat_rating,
          BASELINE + 0x970 => :player_arena_team_info,
          BASELINE + 0x994 => :player_max_level,
          BASELINE + 0x995 => :player_rune_regen,
          BASELINE + 0x999 => :player_no_reagent_cost,
          BASELINE + 0x99D => :player_glyph_slots,
          BASELINE + 0x9A3 => :player_glyphs,
          BASELINE + 0x9A9 => :player_glyphs_enabled,
          BASELINE + 0x9AA => :player_pet_spell_power,
          BASELINE + 0x9AB => :player_researching,
          BASELINE + 0x9B5 => :player_profession_skill_line,
          BASELINE + 0x9B7 => :player_ui_hit_modifier,
          BASELINE + 0x9B8 => :player_ui_spell_hit_modifier,
          BASELINE + 0x9B9 => :player_home_realm_time_offset,
          BASELINE + 0x9BA => :player_mod_pet_haste,
          BASELINE + 0x9BB => :player_summoned_battle_pet_id,
          BASELINE + 0x9BF => :player_bytes_2,
          BASELINE + 0x9C0 => :player_lfg_bonus_faction_id,
          BASELINE + 0x9C1 => :player_loot_spec_id,
          BASELINE + 0x9C2 => :player_override_zone_pvp_type,
          BASELINE + 0x9C3 => :player_item_level_delta,
          BASELINE + 0x9C4 => :player_bag_slot_flags,
